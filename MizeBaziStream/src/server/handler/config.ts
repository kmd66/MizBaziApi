import os from 'os';
import { RtpCodecCapability, MediaKind } from 'mediasoup/node/lib/types';
...
const mediaCodecs: RtpCodecCapability[] = [
    {
        ...
        mimeType: 'audio/opus',
        preferredPayloadType: 100, // Opus (Audio)
        clockRate: 48000,
        channels: 2,
    },
    {
        ...
        mimeType: 'video/VP9',
        preferredPayloadType: 103, // VP9 (Video)
        clockRate: 90000,
    },
    {
        kind: 'video' as MediaKind,
        mimeType: 'video/H264',
        preferredPayloadType: 102, // H.264 (Video)
        clockRate: 90000,
        parameters: {
